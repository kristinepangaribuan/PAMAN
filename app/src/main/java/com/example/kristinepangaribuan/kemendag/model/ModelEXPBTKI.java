...
public class ModelEXPBTKI {
    ...
    public ModelEXPBTKI(String HSXCODE, String GAB, String KD, String PODALTCODE, String OLDCTRYCOD, Double n12, Double n13, Double n14, Double n15, Double n16, Double n17, Double NLALU, Double NSEKA, Double v12, Double v13, Double v14, Double v15, Double v16, Double v17, Double VLALU, Double VSEKA, String PERIOD) {
